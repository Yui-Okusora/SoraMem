...
{
public:
	CRC32_64(uint32_t _poly32 = 0x04C11DB7, uint64_t _poly64 = 0x42F0E1EBA9EA3693)
	{
...
#pragma warning(suppress: 28020)
	...
	uint64_t gf2_matrix_times(const Matrix64& mat, uint64_t vec);

	uint32_t gf2_matrix_times(const Matrix32& mat, uint32_t vec);

	void gf2_matrix_square(Matrix64& square, const Matrix64& mat);

	void gf2_matrix_square(Matrix32& square, const Matrix32& mat);

	void crc64_init_shift_matrix();

	void crc32_init_shift_matrix();
